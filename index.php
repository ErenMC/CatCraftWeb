...
<body>
    <div class="page-container">
        <nav>
            ...
            <div class="menu-left">
                <button id="login-button" onclick="authorizeDiscord()">Войти</button>
        ...
        <section class="main-info">
            ...
            <p>Лучший. <span class="neon-text-container"><span class="neon-text">Кошачий.</span></span> Навсегда!</p>
                ...
                <p>
                <a href="https://wiki.catcraftmc.ru/"class="wiki-button"><img src="img/ico/ds.png"></a>  <a href="https://wiki.catcraftmc.ru/"class="wiki-button"><img src="img/ico/vk.png"></a> <a href="https://wiki.catcraftmc.ru/"class="wiki-button"><img src="img/ico/map.png"></a>
                </p>
                <p style="text-align: center;"><img  src="img/origina1l.png" alt="img" width="1" height="210" /></p> 
            </div>
        </section>
        ...
        <footer>
            <div class="footer-left">
                <p>Неофициальный сайт CatCraft</p>
            </div>
            <div class="footer-center">
                <img src="img/logo2.png" alt="Лого 2" class="footer-logo">
            </div>
            <div class="footer-right">
            <button class="footer-button" onclick="window.location.href='https://example.com';"><img src="img/ico/ds.png" alt="Icon 1"></button>
            <button class="footer-button" onclick="window.location.href='https://example.com';"><img src="img/ico/vk.png" alt="Icon 2"></button>
            <button class="footer-button" onclick="window.location.href='https://example.com';"><img src="img/ico/map.png" alt="Icon 3"></button>
            </div>
        </footer>
    </div>
